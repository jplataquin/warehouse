...
class ProjectAllocationSummaryController extends Controller
{
    ...
    /**
     * Display the printable Project Allocation Summary report.
     */
    public function print(Request $request)
    {
        ...
        if (!$projectId) {
            abort(400, 'Project ID is required to print the report.');
        }
        ...
        return view('reports.project-allocation-summary.print', [
            'project' => $project,
            'fromDate' => $fromDate,
            'toDate' => $toDate,
            'reportData' => $reportData,
