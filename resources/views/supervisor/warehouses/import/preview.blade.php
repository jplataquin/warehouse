...
<div class="container py-4">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold text-primary"><i class="bi bi-eye me-2"></i> Preview Warehouses Import</h5>
            <a href="{{ route('warehouses.import.form') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="card-footer bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <div class="small text-muted">
                Showing <strong>{{ $totalCount }}</strong> rows. <strong>{{ $validCount }}</strong> warehouses ready to import.
            </div>
            <form action="{{ route('warehouses.import.store') }}" method="POST">
                @csrf
