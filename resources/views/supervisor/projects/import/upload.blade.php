        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-primary"><i class="bi bi-file-earmark-excel me-2"></i> Bulk Project Import</h5>
                    <a href="{{ route('projects.import.template') }}" class="btn btn-sm btn-outline-success">
                        <i class="bi bi-download me-1"></i> Download Template
                    </a>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('projects.import.preview') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="alert alert-info border-0 shadow-sm mb-4">
                            ...
                            <ul class="small mb-0">
                                ...
                                <li>Optional Columns: <strong>create_warehouse</strong> (YES/NO)</li>
                                <li>Uniqueness: Project name must be unique in the database.</li>
                            </ul>
                        </div>
